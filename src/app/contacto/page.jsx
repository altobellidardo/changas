    ...
    <article className='min-h-screen bg-brand8'>
      ...
      <main className='my-20'>
        <div className='flex gap-10 justify-center mt-20 flex-col md:flex-row w-fit mx-auto'>
          ...
          {/* tiktok */}
          <Link className='bg-brand6 p-4 rounded-xl text-brand8 flex items-center gap-5 font-semibold text-2xl' href='https://www.tiktok.com/@changasoficial' target='_blank' rel='noopener noreferrer'>
