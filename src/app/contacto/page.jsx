    ...
    <article className='min-h-screen bg-brand8'>
      ...
      <main className='my-20'>
        <div className='flex gap-10 justify-center mt-20 flex-col md:flex-row w-fit mx-auto'>
          {/* mail */}
          <Link className='bg-brand6 p-4 rounded-xl text-brand8 flex items-center gap-5 font-semibold text-2xl' href='mailto:equipo@changasred.com'>
          ...
          {/* instagram */}
          <Link className='bg-brand6 p-4 rounded-xl text-brand8 flex items-center gap-5 font-semibold text-2xl' href='https://www.instagram.com/changasred/' target='_blank' rel='noopener noreferrer'>
          ...
          {/* facebook */}
          <Link className='bg-brand6 p-4 rounded-xl text-brand8 flex items-center gap-5 font-semibold text-2xl' href='https://www.facebook.com/profile.php?id=61559768533201' target='_blank' rel='noopener noreferrer'>
          ...
          {/* tiktok */}
          <Link className='bg-brand6 p-4 rounded-xl text-brand8 flex items-center gap-5 font-semibold text-2xl' href='https://www.tiktok.com/@changasred' target='_blank' rel='noopener noreferrer'>
            <svg xmlns='http://www.w3.org/2000/svg' className='size-16' width='24' height='24' viewBox='0 0 24 24' fill='currentColor'><path stroke='none' d='M0 0h24v24H0z' fill='none' /><path d='M16.083 2h-4.083a1 1 0 0 0 -1 1v11.5a1.5 1.5 0 1 1 -2.519 -1.1l.12 -.1a1 1 0 0 0 .399 -.8v-4.326a1 1 0 0 0 -1.23 -.974a7.5 7.5 0 0 0 1.73 14.8l.243 -.005a7.5 7.5 0 0 0 7.257 -7.495v-2.7l.311 .153c1.122 .53 2.333 .868 3.59 .993a1 1 0 0 0 1.099 -.996v-4.033a1 1 0 0 0 -.834 -.986a5.005 5.005 0 0 1 -4.097 -4.096a1 1 0 0 0 -.986 -.835z' /></svg>
          </Link>
          {/* whatsapp */}
          <Link className='bg-brand6 p-4 rounded-xl text-brand8 flex items-center gap-5 font-semibold text-2xl' href='https://wa.me/5491164063602?text=Buen%20d%C3%ADa,%20estoy%20interesado%20en%20sus%20servicios' target='_blank' rel='noopener noreferrer'>
