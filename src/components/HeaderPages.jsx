...
const disablePath = 'lg:hover:text-primary-700 block border-b border-gray-700 py-2 pl-3 pr-4 text-gray-300 hover:bg-gray-700 hover:text-white lg:border-0 lg:p-0 lg:hover:bg-transparent lg:hover:text-white'
