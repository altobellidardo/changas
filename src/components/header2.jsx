    ...
    <header>
      <nav className='bg-brand5 px-4 lg:px-6 py-2.5'>
        <div className='flex flex-wrap justify-between items-center mx-auto max-w-screen-xl'>
          <Link href='/' className='text-brand8 hover:text-brand1 flex items-center'>
            <img src='/logo.svg' className='mr-3 size-6 sm:size-9 lg:size-12' alt='Logo' />
            <span className='self-center text-2xl font-semibold whitespace-nowrap'>Changas</span>
          </Link>
